    ...
    <div className='pb-24'>
      ...
      <motion.div
        ...
        <motion.div variants={iconVariants(1.25)} initial="initial" animate="animate"
          className='motion-animate rounded-2xl border-4 border-neutral-800 p-4 hover:shadow-[0_0_30px_rgba(25,202,252,0.8)] hover:cursor-pointer hover:bg-zinc-950'>
        ...
        <motion.div variants={iconVariants(2.9)} initial="initial" animate="animate" 
          ...
          <VscAzure className='text-7xl text-sky-400' />
        </motion.div>
      </motion.div>
    </div>
  )
